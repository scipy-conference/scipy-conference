...
authors = np.loadtxt(sys.argv[1],
        delimiter=',',
        dtype={'names': ('paper','invitee', 'email'),
            'formats': ('i4', 'S128', 'S128')})
...
for author in authors:
    ...
    msg['To'] = author['email']
    msg['Cc'] = 'Serge Rey <othername@gmail.com>,Stefan van der Walt<theirname@gmail.com>'
