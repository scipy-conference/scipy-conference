...
def get_fields(fields):
    ...
    if len(split_fields) == 2:
        fieldstr = (
            expertise_name_map[split_fields[0]]
            + " and "
...
for member in pc_invitees:
    ...
    email_body = template.render(
        name=member["invitee"], expertise=fieldstr, isare=is_are_str
    )
    ...
    msg["To"] = member["email"]
    msg["Cc"] = (
        "Serge Rey <sjsrey@gmail.com>,Stefan van der Walt<stefan@sun.ac.za>,Aron Ahmadia<aron@ahmadia.net>"
    )
